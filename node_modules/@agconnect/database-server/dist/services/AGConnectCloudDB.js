...
var AGConnectCloudDB = /** @class */ (function (_super) {
    ...
    AGConnectCloudDB.initialize = function (agcClient) {
        if (!agcClient) {
            console.warn(new __1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.INPUT_IS_NULL).message);
            throw new __1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.INPUT_IS_NULL);
        }
        if (!AGConnectCloudDB.agconnectCloudDB) {
            this.agconnectCloudDB = new AGConnectCloudDB(agcClient);
        }
    };
    /**
     ...
     */
    AGConnectCloudDB.getInstance = function () {
        if (!AGConnectCloudDB.agconnectCloudDB) {
        ...
        return AGConnectCloudDB.agconnectCloudDB;
    };
    /**
    ...
    AGConnectCloudDB.prototype.executeDeleteUserKey = function (uid) {
        if (!uid) {
            console.warn(new __1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.INPUT_IS_NULL).message);
            return Promise.reject(new __1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.INPUT_IS_NULL));
        }
