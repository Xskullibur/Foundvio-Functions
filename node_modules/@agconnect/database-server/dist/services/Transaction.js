...
var Transaction = /** @class */ (function () {
    ...
    Transaction.prototype.executeQuery = function (cloudDBZoneQuery) {
        return __awaiter(this, void 0, void 0, function () {
            var objectData, clazz, myObj, verifyObjects, needVerifyObject, fieldTypeMap, deserializeObjects;
                ...
                switch (_a.label) {
                    case 0:
                        if (!cloudDBZoneQuery) {
                            ...
                            return [2 /*return*/, Promise.reject(new AGConnectCloudDBException_1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.INPUT_IS_NULL))];
                        }
    ...
    Transaction.prototype.checkQueryData = function (objectData) {
        ...
        if (objectData.length > MAX_QUERY_OBJECT_NUM) {
            console.warn(new AGConnectCloudDBException_1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.ERROR_QUERY_DATA_TOO_LARGE).message);
            throw new AGConnectCloudDBException_1.AGConnectCloudDBException(CloudDBErrorCode_1.CloudDBErrorCode.ERROR_QUERY_DATA_TOO_LARGE);
        }
