...
var HttpsCommunicator = /** @class */ (function () {
     ...
     * @parm data the body of the request
     */
    HttpsCommunicator.prototype.sendPostRequest = function (requestUrl, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.generateAuth()];
                    case 1:
                        token = _a.sent();
                        this.requestTemplate.headers.setAuthorization('Bearer ' + token);
                        return [2 /*return*/, this.httpClient.post(this.requestTemplate.url + requestUrl, data, this.requestTemplate.params, this.requestTemplate.headers)];
                    case 2:
                        error_1 = _a.sent();
     ...
     * @parm data the body of the request
     */
    HttpsCommunicator.prototype.sendDeleteRequest = function (requestUrl, data) {
        return __awaiter(this, void 0, void 0, function () {
            var token, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        this.requestTemplate.headers.setAuthorization('Bearer ' + token);
                        return [2 /*return*/, this.httpClient.delete(this.requestTemplate.url + requestUrl, data, {}, this.requestTemplate.headers)];
                    case 2:
                        error_2 = _a.sent();
